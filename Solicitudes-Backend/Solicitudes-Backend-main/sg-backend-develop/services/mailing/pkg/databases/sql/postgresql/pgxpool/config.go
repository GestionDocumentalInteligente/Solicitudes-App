...
import (
	...
	"github.com/teamcubation/sg-mailing-api/pkg/databases/sql/postgresql/pgxpool/defs"
)
...
func (c *config) DNS() string {
	...
	return fmt.Sprintf("postgres://%s:%s@%s/%s?sslmode=require", c.User, c.Password, host, c.DbName)
}
